...
export const SAMPLE_ZAEMESETZLI: ZaemesetzliPuzzle = {
  ...
  emojis: [
    ...
    { emoji: '🔑', canonical_noun: 'Schlüssel', alt_nouns: ['Key', 'Schein', 'Schloss'] },
    ...
    { emoji: '🔔', canonical_noun: 'Glocke', alt_nouns: ['Uhr', 'Bund'] },
    { emoji: '🐄', canonical_noun: 'Kuh', alt_nouns: [] },
    { emoji: '☀️', canonical_noun: 'Sonne', alt_nouns: ['Licht', 'Sonntag'] },
  ...
  valid_compounds: [
    ...
    { word: 'Bergsonntag', components: ['⛰️', '☀️'], difficulty: 3, points: 3, is_mundart: true },
